...
create table DND_BACKGROUND (
	DND_BACKGROUND_ID NUMBER(10),
	LANGUAGES_COUNT             NUMBER(1),
	CONSTRAINT dnd_background_pk PRIMARY KEY (DND_BACKGROUND_ID)
);

create table DND_BACKGROUND_L (
	DND_BACKGROUND_ID NUMBER(10),
	LANG_CODE                   VARCHAR2(2),
	NAME                        VARCHAR2(20),
	DESCRIPTION                 CLOB,
	...
	CONSTRAINT dnd_background_l_pk PRIMARY KEY (DND_BACKGROUND_ID, LANG_CODE)
);

create table DND_CHARACTER_BACKGROUND (
	DND_CHARACTER_ID    NUMBER(10),
	DND_BACKGROUND_ID           NUMBER(10),
	CONSTRAINT dnd_character_background_pk PRIMARY KEY (DND_CHARACTER_ID)
);
...
create table DND_BACKGROUND_SPECIALITY (
	DND_BACKGROUND_SPECIALITY_ID  NUMBER(10),
	DND_BACKGROUND_ID             NUMBER(10),
	LANG_CODE                               VARCHAR2(2),
	NAME                                    VARCHAR2(20),
	DESCRIPTION                             CLOB,
	CONSTRAINT dnd_background_speciality_pk PRIMARY KEY (DND_BACKGROUND_SPECIALITY_ID)
);
ALTER TABLE DND_BACKGROUND_SPECIALITY ADD CONSTRAINT dnd_background_speciality_fk01 FOREIGN KEY (DND_BACKGROUND_ID) REFERENCES DND_BACKGROUND (DND_BACKGROUND_ID);

create table DND_BACKGROUND_SPECIALITY_VALUE (
	DND_BACKGROUND_SPECIALITY_ID  NUMBER(10),
	VALUE                                   VARCHAR2(30)
);

create table DND_BACKGROUND_SKILL (
	DND_BACKGROUND_ID NUMBER(10),
	DND_CLASSIFICATION_ID       NUMBER(10)
);

create table DND_BACKGROUND_TRAIT (
	DND_BACKGROUND_ID     NUMBER(10),
	DND_PERSONAL_CHARACTERISTIC_ID  NUMBER(10),
);

create table DND_BACKGROUND_IDEAL (
	DND_BACKGROUND_ID     NUMBER(10),
	DND_PERSONAL_CHARACTERISTIC_ID  NUMBER(10)
);

create table DND_BACKGROUND_BOND (
	DND_BACKGROUND_ID     NUMBER(10),
	DND_PERSONAL_CHARACTERISTIC_ID  NUMBER(10)
);

create table DND_BACKGROUND_FLAW (
	DND_BACKGROUND_ID     NUMBER(10),
	DND_PERSONAL_CHARACTERISTIC_ID  NUMBER(10)
);
...
create table DND_CHARACTER_BACKGROUND_LANGUAGE (
	DND_CHARACTER_ID NUMBER(10),
	DND_CLASSIFICATION_ID       NUMBER(10)
);
...
CREATE TABLE DND_SUBRACE_PHYSIOGNOMY (
	DND_SUBRACE_ID              NUMBER(10),
	BASE_HEIGHT                 NUMBER(3),
	BASE_WEIGHT                 NUMBER(3),
	HEIGHT_MODIFIER             NUMBER(2),
	HEIGHT_MODIFIER_MULTIPLIER  NUMBER(1),
	WEIGHT_MODIFIER             NUMBER(2),
	WEIGHT_MODIFIER_MULTIPLIER  NUMBER(1)
);
